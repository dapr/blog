...
This is the eighth minor version update since the [announcement of Dapr v1.0]({{< ref v1-announcement >}}).

## Acknowledgements

We would like to extend our thanks to all 83 of the new and existing contributors who helped make this release happen.
