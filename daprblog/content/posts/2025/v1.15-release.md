...
The Actor runtime engine has had a massive overhaul in its implementation. Although no changes have been made to the API surface of Actors themselves, this overhauls see a high improvement to the reliability of handling Actors at scale and in dynamically scaling environments. This work has also been instrumental in making the, now stable, Workflows engine dynamic and durable.
