...
{{% alert title="Upgrade paths" color="primary" %}}
There was a [v1.3.1 patch](https://github.com/dapr/dapr/releases/tag/v1.3.1) released immediately before the v1.4 release, please be sure to follow the appropriate [upgrade path](https://docs.dapr.io/operations/support/support-release-policy/#upgrade-paths).
{{% /alert %}}
