...
See [the upgrading section](#upgrading-to-dapr-111) for instructions on upgrading Dapr to version 1.11.
...
If you don't have the Dapr CLI installed, follow these instructions to [install the CLI](https://docs.dapr.io/getting-started/install-dapr-cli/).
